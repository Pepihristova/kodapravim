            ...
            <?php if(Route::has('login')): ?>
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block" style="margin: 1%;">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/home')); ?>" class="text-sm text-gray-700 underline" style="font-weight: bold; color: #658585; position: relative; left: 90% ">Home</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-sm text-gray-700 underline" style="font-weight: bold; color: #658585; position: relative; left: 88%">Вход</a>

                        <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" class="ml-4 text-sm text-gray-700 underline" style="font-weight: bold; color: #000; position: relative; left: 90%">Регистрация</a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
...
box-shadow: 0px 0px 50px 10px rgba(255,255,255,0.77); "><h1 >Какво да правим?</h1>
                        <h4><a href="<?php echo e(url('results/places')); ?>">Дейности</a></h4>
...
<?php /**PATH F:\xampp\htdocs\FreeTime\resources\views/welcome.blade.php ENDPATH**/ ?>